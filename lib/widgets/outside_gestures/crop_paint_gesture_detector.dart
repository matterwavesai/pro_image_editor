...
class CropPaintGestureDetector extends StatefulWidget {
  const CropPaintGestureDetector({
    super.key,
    this.child,
  ...
  @override
  State<CropPaintGestureDetector> createState() =>
      CropPaintGestureDetectorState();
}

class CropPaintGestureDetectorState extends State<CropPaintGestureDetector> {
